...
public class ProfissionalController {
    ...
    public ProfissionalResponse atualizar(@PathVariable Long id, @Valid @RequestBody ProfissionalRequest request) {
        return ProfissionalResponse.from(profissionalService.atualizar(id, request.toEntity()));
    }
    ...
    public ProfissionalResponse ativar(@PathVariable Long id) {
        return ProfissionalResponse.from(profissionalService.ativar(id));
    }
}
